    ...
    <div className="w-full h-screen bg-surface text-on-surface font-sans overflow-hidden flex flex-col relative">
      <header className="h-20 bg-surface-container-lowest shadow-ambient flex items-center justify-between px-8 z-[60] relative">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-display font-extrabold tracking-tight text-on-surface">COMMAND CENTER</h1>
            <p className="text-[11px] uppercase tracking-[0.05em] text-on-surface/60 font-medium">Provincial Disaster Risk Reduction & Management Office</p>
          </div>
        </div>
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-end">
            <span className="text-[11px] uppercase text-primary font-bold tracking-[0.05em]">● Local Sync Active</span>
            <span className="text-[11px] text-on-surface/60 uppercase tracking-[0.05em] font-medium">Station: Daet Head Office</span>
          </div>
          <button 
          ...
          >
            <BarChart2 size={16} className={isAnalyticsOpen ? 'text-white' : 'text-tertiary'} /> View Analytics
          </button>
        </div>
      </header>
      ...
      <footer className="h-12 bg-surface-container-low flex items-center px-8 justify-between z-50">
        <div className="flex items-center gap-6">
          <div className="text-[11px] text-on-surface/60 uppercase tracking-[0.05em] font-bold">Activity Feed:</div>
          <div className="text-[11px] text-on-surface/80">Vigilant curation active. Ready for field data.</div>
        </div>
        <div className="flex gap-4">
          <div className="text-[11px] px-3 py-1 bg-surface-container text-tertiary font-bold rounded-md uppercase tracking-[0.05em]">Map Status: Online</div>
        </div>
      </footer>
