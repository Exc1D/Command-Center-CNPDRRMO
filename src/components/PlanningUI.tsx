  ...
  return (
    <div className="absolute right-4 top-28 z-[650] w-64 bg-surface-container-highest rounded-xl shadow-lg p-4 max-h-[calc(100%-10rem)] overflow-y-auto">
      ...
      {object ? <>
        ...
        <label className="flex items-center gap-2 text-xs mb-2"><input disabled={!canEdit} type="checkbox" checked={object.locked} onChange={event => planning.updateObject(object.id, { locked: event.target.checked })} />{object.locked ? <Lock size={12} /> : <Unlock size={12} />} Locked</label>
